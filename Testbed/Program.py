...
class TestApp(TestWrapper, TestClient):
    ...
    def start(self):
        ...
        if self.globalCancelOnly:
            ...
            # self.contractOperations()                   # work
            # self.newsOperations_req()
            # self.miscelaneousOperations()
            # self.linkingOperations()                    #work
            # self.financialAdvisorOperations()           #work
            self.orderOperations_req()                  # work order operation
            # self.rerouteCFDOperations()
            # self.marketRuleOperations()                 # work
            # self.pnlOperations_req()
            # self.histogramOperations_req()              # no market data permission for NYSE STK             
            # self.continuousFuturesOperations_req()
            # self.historicalTicksOperations()              
            # self.tickByTickOperations_req()
            # self.whatIfOrderOperations()                  # order history work
    ...
    def optionsOperations_req(self):
        # ! [reqsecdefoptparams]
        self.reqSecDefOptParams(0, "ARLO", "", "STK", 8314)
        # ! [reqsecdefoptparams]
